                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('movie.public', $item->id) }}"
                                                        class="btn btn-success"> <i class="fa fa-recycle mx-1"></i> Recycle
                                                        to Public</a>
                                                    <a href="{{ route('movie.draft', $item->id) }}"
                                                        class="btn btn-info btn-sm mx-2"><i class="fa fa-recycle mx-1"></i>
                                                        Recycle to Draft</a>
                                                    <a href="{{ route('movie.delete.permanent', $item->id) }}"
                                                        class="btn btn-danger mx-2"> <i class="fa fa-trash mx-1"></i>
                                                        Permanent Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
