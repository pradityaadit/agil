                    ...
                    <div class="col-lg-12 col-11">
                        <div class=" card w-100 ">
                            ...
                            <div class="p-lg-5 gap-4 m-lg-5 m-0  justify-content-center align-items-center flex">
                                <form action="{{ route('movie.update', ['id' => $data->id]) }}" method="POST"
                                    ...
                                    <div class="row justify-content-center  align-items-center ">
                                        ...
                                        <div class="col-lg-5 col-12 p-3  ">
                                            ...
                                            <input type="text" id="video_type" name="video_type" class="form-control "
                                        ...
                                        <div class="col-lg-11 col-12 p-3">
                                            ...
                                            <textarea type="text" rows="18" id="editor" name="movie_info" class="form-control "
                                                value="{{ old('movie_info') }}">{!! $data->movie_info !!}</textarea>
                                            @error('movie_info')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-lg-11 col-12 p-3  ">
                                            ...
                                            @if ($data->screenshots)
                                                ...
                                                @endphp
                                            @endif
                                            <textarea type="text" rows="20" id="image_editor" name="screenshots" class="form-control "
                                                value="{{ old('screenshots') }}"> @if ($data->screenshots)
...
@endif
                                        ...
                                        <div class="col-lg-11 col-12 p-3">
                                            ...
                                            <textarea type="text" rows="18" id="btn_editor" name="download_description" class="form-control "
                                                value="{{ old('download_description') }}">{!! $data->download_description !!}</textarea>
                                        ...
                                        <div class="col-lg-11 col-12 p-3  ">
                                            ...
                                            <input type="file" id="image-input" name="thumbnail" class="form-control "
                                        ...
                                        <div class="flex">
                                            <div class="flex flex-col">
                                                <img src="{{ url('/thumbnails' . '/' . $data->thumbnail) }}" width="20%"
                                                    height="auto" alt="img">
                                                <div class="text-sm font-semibold">Current-Thumbnail</div>
                                            </div>
                                            <div class="flex flex-col">
                                                <img id="image-preview" src="#" width="50%" height="auto"
                                                    alt="img">
                                        ...
                                        <div class="row w-100 mt-1 d-flex">
                                            ...
                                            <div class="col-lg-11 col-12 p-3  ">
                                                ...
                                                <input type="text" id="meta_title" name="meta_title"
                                                    class="form-control " value="{{ $data->meta_title }}">
                                                @error('meta_title')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-lg-11 col-12 p-3  ">
                                                ...
                                                <input type="text" id="meta_keywords" name="meta_keywords"
                                                    class="form-control " value="{{ $data->meta_keywords }}">
                                                @error('meta_keywords')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div
                                        class="mt-2 col-lg-12 col-12 text-center justify-content-center align-items-center flex p-5">
